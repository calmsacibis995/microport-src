/* uportid = "@(#)buf.h	Microport Rev Id  1.3.3 6/18/86" */
 ...
 * 		changed hashbuf external for dynamic allocation
 */
...
#define paddr(X)        (paddr_t)(X->b_un.b_addr)
        ...
        unsigned long b_physaddr;       /* physical address to do I/O to/from */
        uint b_cylin;                   /* cylinder number */
        daddr_t b_secno;                /* sector number */
};
...
/*
 * this flag is to allow us to format a floppy without shutting down
 * the system.
 */
