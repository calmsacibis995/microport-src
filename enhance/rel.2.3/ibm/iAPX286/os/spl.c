static char *uportid = "@(#)spl.c	Microport Rev Id 1.3.8  10/19/86";
 ...
 * 	1) changed to use slave masks in ../sys/8259.h. In it's
 *		original form, this did not allow hard disk irq's
 */
...
{
	SPL0SLAVE,	/* spl0 - unused level			*/
	SPL7SLAVE,	/* spl1 - unused level			*/
	SPL7SLAVE,	/* spl2 - unused level			*/
	SPL7SLAVE,	/* spl3 - unused level			*/
	SPL4SLAVE,	/* spl4 - unused level			*/
	SPL5SLAVE,	/* spl5 - unused level			*/
	SPL6SLAVE,	/* spl6 - unused level			*/
