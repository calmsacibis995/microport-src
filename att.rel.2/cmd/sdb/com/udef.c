...
#if iAPX286
ADDR adargs;			/* address of __dbargs */
#else
...
struct filet *files, *badfile, *ffreechain, *fendchain;

struct proct *procs, *badproc, *pfreechain;
...
#if iAPX286
struct proct badproca;
struct filet badfilea;
#endif
