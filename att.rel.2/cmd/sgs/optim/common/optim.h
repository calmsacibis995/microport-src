...
#define saveop(opn, str, len, op) \
	    (void) Saveop((opn), (char *) (str), (unsigned)(len), (op))
#define addtail(p)		/* superfluous */
#define appinst()		/* superfluous */
#define appmisc(str, len)	saveop(0, (char *) (str), (len), MISC)
#define appfl(str, len)		saveop(0, (char *) (str), (len), FILTER)
#define applbl(str, len) \
	(setlab(Saveop(0, (char *) (str), (unsigned)(len), MISC)), --ninst)
