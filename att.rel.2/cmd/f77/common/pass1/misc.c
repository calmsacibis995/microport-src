...
#if TARGET == IAPX286
/*
**	The following code needs to be changed as on the iAPX286 int is
**	only 2 bytes and this code assumes for the most part that 
**	ints, longs and pointers are all the same size and 4-bytes
*/
int *calloc();
ptr ckalloc(n)
register int n;
