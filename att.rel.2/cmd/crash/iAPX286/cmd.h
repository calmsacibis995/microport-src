...
struct	tsw	t[] = {
...
#if iAPX286
	"tty type",	TTY,	"use type tty structure (i.e. con,sio)",
#else
	...
	"ldt",		LDT,	"local descriptor table",
	"idt",		IDT,	"interrupt descriptor table",
	"stkbase",	STKBASE, "system stack /user interface",
	"odl",		ODL,	"print local segment :odl proc addr units form",
	NULL,		NULL,	NULL
};
