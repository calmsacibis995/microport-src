...
#ifdef iAPX286
		     /*
		      * Only the offset is added when a buffer pointer
		      * is added; the offset can wrap when n is large,
		      * and the check for end of buffer will give a
		      * false result.
		      */
